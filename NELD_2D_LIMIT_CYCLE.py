# -*- coding: utf-8 -*-
"""Copy of NELD_2D_LIMIT_CYCLE.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1S3pa4xfRGH-TWxyzlcKNtnPHVBvnI3oG
"""
...
html.Br(),
 html.Hr(style={'border-color': 'white'}),
    ...
    html.Div([
        html.Div(id='output-fig', style={'display': 'inline-block'}),
        html.Div(id='output-fig2', style={'display': 'inline-block'}),
    ],
    style={'textAlign': 'center',
                'color': 'white',
                'background-color' : 'black',
...
@app.callback([
        ...
        Output('output-fig', 'children'),
        Output('output-fig2', 'children'),
    ],
    [
        Input('dropdown-flow' , 'value'),
        Input('input-nPart'   , 'value'),
        Input('input-epsilon'    , 'value'), 
        Input('input-rcut'    , 'value'),  
        Input('input-N'       , 'value'),
        Input('input-Nperiod' , 'value'),
...
def update_output(flow,nPart,epsilon,rcut,N,Nperiod): 
        ...
        fig = dcc.Graph( figure = plot_history_matrixxy(sav,pbc['dt'],bheight,bwidth)) 
        fig2 = dcc.Graph(figure= plot_history_matrixxy2(sav,datF,param,pbc,bheight,bwidth))
